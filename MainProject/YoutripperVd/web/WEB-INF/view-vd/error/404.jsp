...
<html lang="${pageContext.response.locale}" currency="${sessionScope.ytCurrency}" ng-app="youtripper" ng-controller="YoutripperController">
    <head>
        ...
        <title>Youtripper - Page Not Found</title>
    </head>
    <body ng-cloak>
                ...
                <div class="yt-normal-container">
                    <div class="clearfix">
                        ...
                        <div class="error-ct">
                            ...
                            <div class="txt">
                                <div class="name">
                                    <spring:message code="yt.404.error.name"/>
                                </div>
                                <p class="err-txt">
                                    <spring:message code="yt.404.error.content"/> <span class="hl-s" ng-bind="scs"></span> <spring:message code="yt.404.error.txt.seconds"/>
                                </p>
                            </div>
                            <div class="b-btn">
                                <a href="${sessionScope.hrefLocale}/" class="yt-btn red-btn">
                                    <spring:message code="yt.404.error.btn.back"/>
                                </a>
                            </div>
                        </div>
                    </div>
